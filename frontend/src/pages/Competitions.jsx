    ...
    <div className="comp">
     ...
     <section>
        <div ref={ref} className="sec2">
            ...
            <Block year={comp2.year}img={comp2.img} title={comp2.title} subheading={comp2.subheading}>
              <span>AIR 18</span>
              <p>2nd in innovation</p> 
              <h2>ATVC 2023</h2>
              <span>1st in design round</span>
            </Block>
            <Block year={comp3.year}img={comp3.img} title={comp3.title} subheading={comp3.subheading} >
              A sleek and speedy electric go-kart, to participate in ISIE IKR 2023
            </Block>
            <Block year={comp4.year}img={comp4.img} title={comp4.title} subheading={comp4.subheading}>
              <p>AIR 4 in virtual round</p>
              <p>Best AWD Award</p>
            </Block>
            <Block year={comp5.year}img={comp5.img} title={comp5.title} subheading={comp5.subheading}>
              <p>AIR 2</p> 
              <p>6th in sales presentation</p> 
            </Block>
            <Block year={comp6.year}img={comp6.img} title={comp6.title} subheading={comp6.subheading}>
              <p>Ranked 26th among all the participating teams in India</p>
              <p>6th in virtual round</p>
            </Block>
            <Block year={comp7.year}img={comp7.img} title={comp7.title} subheading={comp7.subheading}>
              <p> 7th Rank in the Marketing Event</p>
              <p> 10th Rank in the Design Challenge</p>
              <p> 14th in the Acceleration Event</p>
            </Block>
            <Block year={comp8.year}img={comp8.img} title={comp8.title} subheading={comp8.subheading}>
              <p> 1st in Sales presentation</p>
              <p> 3rd in Virtual evaluation</p>
              <p> 4th in the Cost Event</p>
            </Block>
            <Block year={comp9.year}img={comp9.img} title={comp9.title} subheading={comp9.subheading}>
            ...
            <Block year={comp10.year}img={comp10.img} title={comp10.title} subheading={comp10.subheading}>
              <p> Scored 3rd highest points in the most ruthless Suspension Traction Event</p>
              <p> Ranked 9th in acceleration among all 149 teams from across the country</p>
            </Block>
            <Block year={comp11.year}img={comp11.img} title={comp11.title} subheading={comp11.subheading}>
              <p>Ranked 1st in Acceleration Event</p>
              <p>Ranked 5th in Business Presentation Round</p>
              <p>Ranked 7th in Maneuverability Event</p>
              <p>Overall Secured 7th amongst all teams all over India</p>
            </Block>
            <Block year={comp12.year}img={comp12.img} title={comp12.title} subheading={comp12.subheading}>
            ...
            <Block year={comp13.year}img={comp13.img} title={comp13.title} subheading={comp13.subheading}>
              <p>Winners of Safest Kart Award</p>
              <p>Winners of Best Marketing Scope Award</p>
              <p>Winners of Most Synchronized Team Award</p>
              <p>Ranked 2nd among all participating teams in India</p>
            </Block>
            <Block year={comp14.year}img={comp14.img} title={comp14.title} subheading={comp14.subheading}>
              <p>Ranked among the top 15 teams in the endurance race</p>
              <p>Nominated among the top teams for Computer-Aided Engineering Award</p>
              <p>Ranked 36th among all the participating teams in India</p>
            </Block>
            <Block year={comp15.year}img={comp15.img} title={comp15.title} subheading={comp15.subheading}>
              <p>Winners of Business Presentation Award</p>
              <p>Ranked 1st in Mumbai</p>
              <p>Ranked 12th among all participating teams in India</p>
            </Block>
            <Block year={comp16.year}img={comp16.img} title={comp16.title} subheading={comp16.subheading}>
              <p>Won the Raftaar Award for the most dynamic car.</p>
              <p>Nominated among the top 10 teams in the computer-Aided Engineering category</p>
              <p>Ranked 35th among all the participating teams in India</p>
            </Block>
